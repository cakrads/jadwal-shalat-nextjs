// modified from : https://www.al-habib.info/islamic-calendar/hijricalendar-kuwaiti.js
...
export const writeIslamicDate = (adjustment = 0) => {
  ...
  // const outputIslamicDate = wdNames[iDate[4]] + ', '
